...
export class LogInComponent {
    ...
    /**
    * Logs in using predefined guest credentials.
    * This does not use Firebase anonymous authentication,
    * but fills the login form with a static guest account and triggers a regular login.
